...
import { HomePage } from '../../pages/Automation Exercise/homePage.page';
...
test.describe('Home', () => {
    ...
    test('Test Case 22: Add to cart from Recommended items', async ({ page }) => {
        const playwrightDev = new HomePage(page);
        let items = [await playwrightDev.addProductFromRecommended(0)]
...
test.describe('Order', () => {
    test('Test Case 14: Place Order: Register while Checkout', async ({ page }) => {
        ...
        await playwrightDev.continueShopping()
        await playwrightDev.gotoCartPage()
        await playwrightDev.proceedToCheckoutNotLogged()
        await playwrightDev.signupFromCart()
        await playwrightDev.signup(user)
        await playwrightDev.gotoCartPage()
        await playwrightDev.proceedToCheckoutLogged()
